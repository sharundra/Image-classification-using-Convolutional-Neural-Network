...
class NetworkBuilder:
    def __init__(self):
        pass
    def attach_conv_layer(_self, input_layer, output_size=32, feature_size=[5,5], strides = [1,1,1,1], padding = "SAME", summary = False):
    ...
    def attach_relu_layer(self, input_layer):
        with tf.name_scope("Activtion") as scope:
